    ...
    <div>
        ...
        >
            ...
            <el-collapse-item class="item" title="修改信息" name="2">
                ...
                >
                    <el-col :span="8"
                        ><div v-bind:class="{ must: item.must }">
                            <b>{{ item.field }}</b>
                        </div></el-col
                    >
                    <el-col :span="16"
                ...
                <el-row :gutter="20" id="button_content">
                    <el-button id="edit" @click="edit" type="primary"
                        >修改</el-button
                    >
                    <el-button id="reset" @click="reset" type="primary" plain
                        >重置</el-button
                    >
                </el-row>
            </el-collapse-item>
...
function beforeAvatarUpload(file) {
    ...
    if (!isValid) web.web.showAlert("上传头像图片格式不正确！");
    else if (!isLt2M) web.web.showAlert("上传头像图片大小不能超过 2MB！");
