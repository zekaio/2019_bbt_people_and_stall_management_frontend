        ...
        <transition name="el-zoom-in-center">
            <div id="create_content" v-show="!created">
                ...
                <el-row :gutter="20" class="grid-content bg-purple">
                    ...
                    <el-col :span="20"><div>
                        <el-input id="name_input" v-model="name" clearable maxlength="16"
                                  @focus="onFocus" placeholder="请输入项目名称">
                        </el-input>
                    </div></el-col>
                </el-row>
                <el-row :gutter="20" class="grid-content bg-purple">
                    ...
                    <el-col :span="20"><div id="desc_container">
                        <el-input id="desc_input" v-model="description" type="textarea"
                ...
                <el-row :gutter="20" class="button_content">
                    <el-button id="create" @click="create" type="primary">添加</el-button>
                </el-row>
            </div>
        </transition>
        <transition name="el-zoom-in-center">
            <div id="sub_stall_content" v-show="created">
                ...
                <el-row :gutter="20" class="grid-content bg-purple">
                    <el-col :span="4"><div>名称</div></el-col>
                    <el-col :span="20"><div>
                        <el-input id="sub_name" v-model="sub_name" clearable
                ...
                <el-row :gutter="20" class="grid-content bg-purple">
                    ...
                    <el-col :span="20"><div>
                        <el-input id="location_input" v-model="location" clearable
                ...
                <el-row :gutter="20" class="grid-content bg-purple">
                    ...
                    <el-col :span="20"><div>
                        <el-select id="start_sess" v-model="start_sess" placeholder="请选择">
                            <el-option v-for="opt in sess_options"
                ...
                <el-row :gutter="20" class="grid-content bg-purple">
                    ...
                    <el-col :span="20"><div>
                        <el-select id="end_sess" v-model="end_sess" placeholder="请选择">
                            <el-option v-for="opt in sess_options"
                                       :key="opt" :label="opt" :value="opt">
                            </el-option>
                        </el-select>
                ...
                <el-row :gutter="20" class="grid-content bg-purple">
                    ...
                    <el-col :span="20"><div>
                        <el-input-number v-model="num" :min="0" :max="99" label="摆摊人数"></el-input-number>
                    </div></el-col>
                </el-row>
                <el-row :gutter="20" class="grid-content bg-purple">
                    <el-col :span="4"><div>日期</div></el-col>
                    <el-col :span="20"><div>
                        <el-date-picker id="date_input" v-model="date"
                ...
                <el-row :gutter="20" class="button_content">
                    ...
                    <el-button id="close" @click="close" type="primary">返回</el-button>
                </el-row>
            </div>
        </transition>
    </div>
...
<script>
    ...
    async function create() {
        ...
        let res = validateCreate.call(this) &&
    ...
    async function add() {
        ...
        if(!res) return;
        res = await stall.createSubStall(cur_stall.id,
            this.location, this.date, this.num, this.start_sess, this.end_sess);
        console.info(res);
        if(!res) web.web.showAlert("添加摆摊成功！目前本项目已有 "+(this.counter++)+" 个摆摊活动，你可继续添加。");
    }
    ...
    export default {
        ...
        methods: {
            create, add, onFocus, onDateFocus, close
        }
    }
</script>
