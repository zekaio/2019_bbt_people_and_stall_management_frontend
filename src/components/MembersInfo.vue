        ...
        <transition name="el-zoom-in-center">
            <div id="main_content" v-show="!detail && !edit">
                <el-tabs v-model="main_page" @tab-click="onTabChanged">
                    ...
                    <el-tab-pane label="同管理层成员" name="group"></el-tab-pane>
                </el-tabs>
...
<script>
    ...
    async function loadData(self, page) {
        ...
        switch (page || self.main_page) {
            case "all": res = await admin.getAllMembers(self.current_page); break;
            case "dept": res = await admin.getDeptMembers(self.current_page); break;
            case "group": res = await admin.getGroupMembers(self.current_page); break;
        }
        if(res){
